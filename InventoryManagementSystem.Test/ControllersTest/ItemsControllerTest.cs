...
namespace InventoryManagementSystem.Test.ControllersTest
{
    public class ItemsControllerTest
    {
        ...
        [Fact]
        public void TestFindMatch_ReturnOkObject_ValueIsListOfItemsDTO_PaginationHeaderTotalEqualsListCount()
        {
            ...
            var actionResult = controller.FindMatch("snips", It.IsAny<int>(), It.IsAny<int>());
